      ...
      <div className="relative z-10 container mx-auto px-5 sm:px-6 lg:px-8 py-20 md:py-32">
        <div className="max-w-3xl scroll-reveal">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">
            Pré-lançamento da{" "}
            <span className="highlight-text">Expansão Rarity</span> Chalés
          </h1>
          <p className="text-foreground/70 text-lg md:text-xl leading-relaxed mb-8">
            Evento ao vivo com o CEO{" "}
            <strong className="text-foreground">Victor Alfenas</strong>. Venha
            participar e saiba todos os detalhes de como ser sócio nesse
